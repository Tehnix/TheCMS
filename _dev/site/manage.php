...
class UsersHandler
{
    ...
    function addNewUser($username, $password, $first_name,
        ...
        $q = "INSERT INTO " . TBL_USERS 
            ...
            . "'$last_name', '$firm',  '0', $ulevel, '$email', '0', $time)";
...
class Mailer
{
    ...
    function sendWelcome($user, $email, $pass){
        ...
        $subject = "Welcome!";
        $body = new Template(TEMPLATES_ROOT . 'email' . DS . 'sendWelcome.tpl');
...
class Session
{
    ...
    function login($subuser, $subpass, $subremember){
        ...
        $this->firm = $_SESSION['firm'] = $this->userinfo['firm'];
    ...
    function register($subuser, $subpass, $subemail, 
                     $subfirst_name, $sublast_name, $subfirm){
    ...
    /* firm error checking */
        $field = "firm";  //Use field name for firm
        if(!$subfirm){
            $Form->setError($field, "* Firm not choosen");
        }
     ...
     * returns 0. Returns 2 if registration failed.
     */
    function create($subcuser, $subcpass, 
                    $subcfirst_name, $subclast_name, $subcregkey){
        global $UsersHandler, $Form, $Mailer;
     ...
     * an user level 2, false otherwise.
     */
    function isUser2(){
