    ...
    <div id="container">
        ...
        <table align="left" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
                ...
                <td><input class="textfields" type="text" name="first_name" maxlength="30"  value="{% FORM_FIRSTNAME %}"></td>
                <td>{% ERROR_FIRSTNAME %}</td>
            </tr>

            <tr>
                <td><font class="norm">Lastname:</font></td>
                <td><input class="textfields" type="text" name="last_name" maxlength="30"  value="{% FORM_LASTNAME %}"></td>
                <td>{% ERROR_LASTNAME %}</td>
            </tr>
            
            <tr>
                <td><font class="norm">E-mail:</font></td>
                <td><input class="textfields" type="text" name="email" maxlength="30"  value="{% FORM_EMAIL %}"></td>
                <td>{% ERROR_EMAIL %}</td>
            </tr>
