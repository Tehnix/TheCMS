    ...
    <div id="container">
        ...
        <table align="left" border="0" cellspacing="0" cellpadding="3">
            <tr>
                ...
                <td><input type="text" name="cuser" maxlength="30"  value="{% FORM_USER %}"</td>
                <td>{% ERROR_USER %}</td>
            </tr>

            <tr>
                <td><font class="norm">Password:</font></td>
                <td><input type="password" name="cpass" maxlength="30"  value="{% FORM_PASS %}"></td>
                <td>{% ERROR_PASS %}</td>
            </tr>

            <tr>
                <td><font class="norm">Firstname:</font></td>
                <td><input type="text" name="cfirst_name" maxlength="30"  value="{% FORM_FIRSTNAME %}"></td>
                <td>{% ERROR_FIRSTNAME %}</td>
            </tr>

            <tr>
                <td><font class="norm">Lastname:</font></td>
                <td><input type="text" name="clast_name" maxlength="30"  value="{% FORM_LASTNAME %}"></td>
                <td>{% ERROR_LASTNAME %}</td>
            </tr>

            <tr>
                <td><font class="norm">E-mail:</font></td>
                <td><input type="text" name="cemail" maxlength="30"  value="{% FORM_EMAIL %}"></td>
                <td>{% ERROR_EMAIL %}</td>
            </tr>

            <tr>
                <td><font class="norm">Registration key:</font></td>
                <td><input type="text" name="cregkey" maxlength="90"  value="{% FORM_REG %}"></td>
                <td>{% ERROR_REG %}</td>
            </tr>
            <tr>
